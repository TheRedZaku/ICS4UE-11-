    ...
    public static void newMessage(String username, int messageIndex) throws InterruptedException {
        ...
        do {
            try {
                ...
                System.out.print("\033[1;36mWhat message would you like to save [Cannot contain symbols or numbers]: \033[0m");
                ...
                if (message.matches(".*[^\\s\\p{L}].*")) {//regex for non unicode or whitespace characters
    ...
    public static void oldMessageList(String username, int max) throws InterruptedException{
        ...
        do {
            try {
                ...
                if (messageIndex <= 0 || messageIndex > max) {//Cannot be more messages than there are indexes
                ...
                for (Storage sameUser: programUsers) {
                    if (sameUser.getUsername().equalsIgnoreCase(username)) {
                        ...
                        if(messageIndex == actualIndex) {
                            ...
                            System.out.println("User: " + sameUser.getUsername() + " posted: " + message + " on " + sameUser.getDate());
